...
{
    using global::StorageMaster.Entities.Factories;
    ...
    public class StorageMaster
    {
        ...
        {
            if (this.productsPool.ContainsKey(type) == false)
            {
        ...
        {
            if (this.storageRegistry.ContainsKey(sourceName) == false)
            {
                throw new InvalidOperationException("Invalid source storage!");
            }

            if (this.storageRegistry.ContainsKey(destinationName) == false)
            {
